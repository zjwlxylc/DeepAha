...
**当前推进入口（2026-09-13）：** [审核闭环与 Scout 接入实施路线](../superpowers/plans/2026-09-13-review-and-scout-delivery-roadmap.md)。本轮已核对当前 HEAD `d0918ec1245264e271f42a18d54c0fb903000c00` 与外部代码评估快照一致；真实任务已有 `APPROVE / INTERNAL_INTAKE_ONLY` 记录，尚无岗位绑定或字段准备。登录多窗口修复与队列摘要分页已由 PR #53 合并；[对象工作台与持久数据接续](2026-09-13-object-review-workbench.md)已完成本地工程验证，真人闭环因用户明确反馈无法理解操作而暂停；正在交付[逐步核对向导](2026-09-13-guided-human-review.md)，工程检查不替代用户可用性验收。后续顺序为队列摘要分页、对象化审核和真人小闭环，再衔接 Scout 暂存回执、可信资格和用户端。该入口取代下列历史段落的“当前”时间含义，不改写历史验收。

**本次集成状态（2026-09-11，已合入 main 至 PR #47）：** 调查证据、受限资格、公告与单位组继承预览、跨层审阅及关系提案/独立裁决已分批集成；关系私有列表、详情、创建表单和当前审阅队列已合并。主线提交 `9ca7dee0d58c53ae4665661e8addd3c750dbc58c`；PR #47 候选 CI #149 九项通过，合并与候选同树。完整条件、例外执行及真实个人资格尚未完成。详见 [当前缺口与下一步](2026-09-11-development-status-and-next-steps.md)，[CI 去重](2026-09-11-ci-deduplication.md)已由 PR #48 合并（候选 CI #152 九项通过、合并同树）；[岗位条件范围预检](2026-09-11-unit-scope-preflight.md)已由 PR #49 合并（候选 CI #154 九项通过、合并同树）；本批接入 [私有预检页面](2026-09-11-unit-scope-preflight-ui.md)。
...
| 单位组来源关联 | [完整成员、稳定身份和私有 API](2026-09-10-group-source-bindings.md)，PR #25 已合并 |
| 单位组来源管理页面 | [预览、登记与当前来源复核](2026-09-10-group-source-ui.md)，已集成 |
| 组级继承与跨层审阅 | [组继承预览](2026-09-10-group-inheritance-preview.md)、[跨层审阅](2026-09-10-cross-level-condition-review.md) |
| 关系提案、裁决与当前队列 | [私有审阅](2026-09-11-relation-review-desktop.md)、[创建表单](2026-09-11-relation-proposal-form.md)、[当前队列](2026-09-11-relation-review-queue.md)，PR #45–47 已合并 |

历史固定公告的 WMA 调查记录（本批未重新运行）；同批文件仍为 **94 PASS / 0 FAIL / 30 Word UNVERIFIED，Delivery UNVERIFIED**。三十条旧 Word 引用缺少生产 Reader，诊断发现原文不等于机械通过。当前集成不重新调用 WMA、不改提示词或冻结原件。真实独立批准、完整适用范围、例外、Gold 与真人发布资格尚未完成；整体资格继续保留 UNCERTAIN。后续按[范围与例外集成顺序](../superpowers/plans/2026-09-08-unit-scope-integration-order.md)逐批推进。

下列为 2026-09-07 的历史检查记录；当前状态以上面的 2026-09-11 集成说明为准，原阶段 Gate 与历史证据不因此自动改写。
