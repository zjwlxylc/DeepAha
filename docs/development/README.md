...
**本次集成状态（2026-09-09，已合入 main 至 PR #22）：** 调查及证据回收、通用核验与持久定位、机会/岗位身份、独立字段审核、规则候选及独立规则裁决、受限资格内核、受信岗位条件快照及其私有管理页面已经分批合并；快照到持久化合成画像的实际回放、公告规则对精确岗位的独立适用性审阅也已合并。最新主线提交为 `0d3260be7ffcb91ace4bfd022b4d94eb3c5ae96f`；PR #22 的最终候选 CI #99 全部九项通过，合并与候选同树，main CI #100 成功。尚未完成真实个人资格或发布资格。
...
| 本批：公告继承快照 | [独立派生版本与完整来源](2026-09-09-announcement-inherited-snapshots.md)，本地验证通过，候选集成中 |
...
下列为 2026-09-07 的历史检查记录；当前状态以上面的 2026-09-09 集成说明为准，原阶段 Gate 与历史证据不因此自动改写。
