...
**本次集成状态（2026-09-10，已合入 main 至 PR #25）：** 调查及证据回收、通用核验与持久定位、机会/岗位身份、独立字段审核、规则候选及独立规则裁决、受限资格内核、受信岗位条件快照及其私有管理页面已经分批合并；快照到持久化合成画像的实际回放、公告规则对精确岗位的独立适用性审阅和完整公告继承快照也已合并。最新主线提交为 `ee96b8a2d2b7bc49ca330e532ae9444584c50ffa`；PR #25 的最终候选 CI #105 全部九项通过，合并与候选同树，main CI #106 成功。尚未完成真实个人资格或发布资格。
...
| 本批：单位组来源管理页面 | [预览、登记与当前来源复核](2026-09-10-group-source-ui.md)，本地定向验证通过，候选 CI 待完成 |
