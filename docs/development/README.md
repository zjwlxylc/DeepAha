...
**本次集成状态（2026-09-11，已合入 main 至 PR #47）：** 调查证据、受限资格、公告与单位组继承预览、跨层审阅及关系提案/独立裁决已分批集成；关系私有列表、详情、创建表单和当前审阅队列已合并。主线提交 `9ca7dee0d58c53ae4665661e8addd3c750dbc58c`；PR #47 候选 CI #149 九项通过，合并与候选同树。完整条件、例外执行及真实个人资格尚未完成。详见 [当前缺口与下一步](2026-09-11-development-status-and-next-steps.md)，本批先做 [CI 去重](2026-09-11-ci-deduplication.md)。
