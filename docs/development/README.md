...
**本次集成状态（2026-09-08，已合入 main 至 PR #21）：** 调查及证据回收、通用核验与持久定位、机会/岗位身份、独立字段审核、规则候选及独立规则裁决、受限资格内核、受信岗位条件快照及其私有管理页面已经分批合并；快照到持久化合成画像的实际回放也已验证并合并。最新主线提交为 `32983b69ba0e2d153b5e31e62d362492941f727b`；PR #21 的最终候选 CI #97 全部九项通过，合并与候选同树，main CI #98 成功。尚未完成真实个人资格或发布资格。
...
| 本批：公告规则适用性审阅 | [来源与目标绑定、追加审阅和私有页面](2026-09-08-announcement-rule-applicability.md)，本地验证及候选集成中 |
