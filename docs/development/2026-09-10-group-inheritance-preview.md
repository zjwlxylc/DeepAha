...
本批 IMPLEMENTED，本地定向验证通过；独立代码审阅未发现可复现的 P1/P2。PR #36 精确候选 CI #127 全部 9 个任务通过，已合并为 `48f6d8b135398741341cf3d2f483418a850104eb`，候选与合并代码树一致；证据见 `evidence/2026-09-10-group-inheritance-preview-ci.json`。这不代表正式发布资格或可执行继承计划。前置 PR #35 已经通过 CI #125 全部 9 个任务，合并为 `81fd0706eb5b2458aa6deddfe493c68df8552400`，候选与合并树一致。
