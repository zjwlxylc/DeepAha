...
class EvidenceRef(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "'docx_table_cell', 'opaque_whole_file') and locator_value is null "
            "and locator_payload is not null)"
...
class DocumentBlock(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "block_type = 'OPAQUE_BINARY' OR length(btrim(canonical_text_or_value)) >= 1",
