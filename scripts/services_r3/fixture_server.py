...
# TEST ONLY: reserved example domains are synthetic and not resolved externally.
app.state.membership_tracking.dns=lambda url:['93.184.216.34']
uvicorn.run(app,host='127.0.0.1',port=int(os.environ['DEEPAHA_QA_PORT']),log_level='warning')
