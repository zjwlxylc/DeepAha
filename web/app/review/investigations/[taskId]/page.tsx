...
import { materialName, safeOfficialUrl } from "../../../../lib/investigation-evidence-links";
...
import { investigationFailureMessage, investigationIssueMessage, investigationStatus } from "../../../../components/investigations/status";
  ...
  return (
    <main id="main-content" data-investigation-status={task.status} className="page-shell human-test-shell investigation-shell">
      ...
      {task.delivery_hash ? <nav className="review-workbench-nav" aria-label="审核工作台导航">
        ...
        <a href="#investigation-review-title">记录材料审核</a><a href="#investigation-field-review-title">逐项确认条件</a>
        <a href="#investigation-rule-review-title">资格条件与范围</a>
      </nav> : null}
